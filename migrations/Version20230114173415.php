 ...
 */
final class Version20230114173415 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE images (id INT AUTO_INCREMENT NOT NULL, url VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE images_cars (images_id INT NOT NULL, cars_id INT NOT NULL, INDEX IDX_AFC92CEBD44F05E5 (images_id), INDEX IDX_AFC92CEB8702F506 (cars_id), PRIMARY KEY(images_id, cars_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
